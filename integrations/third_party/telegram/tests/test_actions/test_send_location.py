...
class TestSendLocation:
    ...
    def test_send_location_success(
        ...
        assert request.kwargs["params"] == {"chat_id": self.CHAT_ID, "latitude": self.LATITUDE, "longitude": self.LONGITUDE}

        assert action_output.results.output_message == "The location was sent successfully"
        assert action_output.results.execution_state == ExecutionState.COMPLETED
        assert action_output.results.json_output.json_result == {"ok": True, "result": {"chat_id": self.CHAT_ID, "latitude": self.LATITUDE, "longitude": self.LONGITUDE}}
    ...
    def test_send_location_failure(
        ...
        assert action_output.results.output_message == "Could not sent location. Error: b'Mock API failure'"
