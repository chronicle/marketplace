...
from integrations.third_party.telegram.actions.GetMessages import main as GetMessages
...
class TestGetMessages:
    ...
    def test_get_messages_success(
        ...
        assert request.kwargs["params"] == {"offset": self.OFFSET_PARAM, "allowed_updates": self.ALLOWED_UPDATES}

        assert action_output.results.output_message == "The messages were pulled successfully."
    ...
    def test_get_messages_failure(
        ...
        assert action_output.results.output_message == "Could not get messages. Error: b'Simulated API failure for GetMessages'"
