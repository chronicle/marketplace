...
from ..core import email_parser, email_parser_regex, email_parser_routing
...
def parse_transport(name, header):
    ...
    try:
        ...
        if header:
            ...
            ips_in_received_line_v4 = email_parser_regex.ipv4_regex.findall(
                received_line_flat,
            )
            ips_in_received_line_v6 = email_parser_regex.ipv6_regex.findall(
                received_line_flat,
            )
...
def process_attachment(attachment, denylist, is_allowlist, stop_transport):
    ...
    try:
        attached_parsed = email_parser.decode_email_b(
            attached_msg,
